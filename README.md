...
| Storyboard (trang 4/6 panel) | `GET /projects/{pid}/sheets`, `GET /scenes/{sid}/sheets`, `POST /scenes/{sid}/sheets`, `…/sheets/autofill`, `POST /projects/{pid}/sheets/autofill-all`, `PATCH /sheets/{id}`, `PATCH /panels/{id}`, `DELETE /sheets/{id}`, `POST /sheets/{id}/generate`, `GET /sheets/{id}/prompt-preview`, `POST /projects/{pid}/sheets/generate-all`, `POST /sheets/{id}/prompt`, `POST /sheets/{id}/video`, `POST /projects/{pid}/sheets/video/generate-all` |
